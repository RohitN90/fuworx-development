...
const CarrerPage = (): React.ReactNode => {
  return (
    <>
      <div
        className={`w-full h-[800px] md:h-screen bg-cover flex flex-col justify-center bg-blend-multiply bg-[#0A1F44]/80 items-center bg-bottom bg-no-repeat relative carrers`}
      >
